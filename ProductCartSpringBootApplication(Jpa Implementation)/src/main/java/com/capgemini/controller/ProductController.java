...
public class ProductController {
	...
	public Products createProduct(@Valid @RequestBody Products products)
			throws DuplicateProductIdException, ProductNotFoundException {
	...
	public Products findProduct(@Valid @RequestBody Products products, @Valid @PathVariable String id)
